...
- 一张卡只说一件事：75 张，卡面平均 15.6 字符、最长 19；选项最多 7，反馈最多 20。
...
14 项 Node 测试与 3 项 Python 测试通过，覆盖原版 UI、短卡预算、开场分支、长存档、资源归零救援、峰值缓冲、主动退场和坏存档。模拟时长只是观测窗口，不是游戏上限；模拟结果也不替代真人试玩。
