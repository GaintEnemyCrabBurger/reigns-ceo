...
| V5 · GPT 6 Astra | Real-business founder story; 78 short cards, original UI, open-ended operation and branching consequences | `v5-sixthirty/玩.html` |
| V6 · 上位 | Independent upstart-to-CEO deck; 89 cards, hidden risk/evidence, CEO open world, explicit high-drama endings | `v6-upstart/玩.html` |

The original game remains in the parent `game` directory. V6 is an independent fork with its own source deck and self-contained HTML. The GPT 6 Astra work remains an independent historical version, and Claude's separate iteration remains in `../startup/`.
